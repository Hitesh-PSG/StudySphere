...
import { Bell, Sparkles, CheckCheck, LogOut, LayoutDashboard } from 'lucide-react';
            ...
            <>
              ...
              {isProfileOpen && (
                 <div className="absolute top-full right-0 w-60 mt-2 bg-slate-800 border border-slate-700 rounded-lg shadow-2xl z-50">
                    ...
                    <div className="p-2">
                        <Link to="/" onClick={() => setProfileOpen(false)} className="w-full text-left flex items-center gap-3 px-3 py-2 text-sm text-slate-300 hover:bg-slate-700/50 rounded-md">
