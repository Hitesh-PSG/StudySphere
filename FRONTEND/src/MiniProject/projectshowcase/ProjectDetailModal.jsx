      ...
      >
        <div className="overflow-y-auto">
          <div className="relative">
            <img 
              src={project.thumbnail || `https://source.unsplash.com/random/800x400?abstract,dark,${project.title}`} 
              alt={`${project.title} thumbnail`}
              className="w-full h-56 md:h-72 object-cover rounded-t-2xl" 
            />
            <div className="absolute inset-0 bg-gradient-to-t from-gray-900 via-gray-900/70 to-transparent"></div>
            <div className="absolute bottom-0 left-0 p-6 md:p-8">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-white" style={{ textShadow: '0 2px 10px rgba(0,0,0,0.5)' }}>
                {project.title || "Untitled Project"}
              </h2>
            </div>
            <button 
              onClick={onClose} 
              className="absolute top-4 right-4 text-gray-300 hover:text-white bg-black/40 rounded-full p-1.5 transition-colors z-10"
          ...
          <div className="p-6 md:p-8">
            ...
            <h3 className="text-lg font-semibold text-yellow-400 mb-2">About this project</h3>
